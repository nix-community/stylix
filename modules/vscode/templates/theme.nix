colors: with colors.withHashtag; {
  ...
  colors = {
    ...
    "button.hoverBackground" = "${accent}C0";
    ...
    "chat.slashCommandBackground" = accent;
    ...
    "debugView.stateLabelBackground" = accent;
    ...
    "editorOverviewRuler.currentContentForeground" = accent;
    ...
    "extensionButton.hoverBackground" = "${accent}C0";
    ...
    "inputValidation.infoBackground" = accent;
    ...
    "merge.currentContentBackground" = "${accent}18";
    "merge.currentHeaderBackground" = "${accent}66";
    ...
    "mergeEditor.conflict.handledFocused.border" = accent;
    ...
    "tab.inactiveModifiedBorder" = accent;
    ...
    "tab.unfocusedInactiveModifiedBorder" = accent;
    ...
    "testing.message.info.lineBackground" = "${accent}20";
